...
const FAQs: FAQ[] = [
    {
        ...
        answer: "No, this is a project created for learning purposes. It is not an actual product.",
    },
    {
    ...
    },
    {
        ...
        answer: "No, the payment features are not active yet. It will be implemented in the future.",
    },
    {
        question: "Can I contribute to this project?",
        answer: "Yes, you can contribute to this project by submitting a pull request on GitHub.",
    },
    {
        question: "Can I use the code from this project in my own work?",
        answer: "Yes, you can use the code as a learning resource or as a base for your own projects.",
    },
];
