  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="mb-6">
       ...
       >
         Stop worrying about invoices, expenses, and taxes. Fintraq helps freelancers and self-employed professionals take control of their finances in minutes, not hours.
       </motion.p>
